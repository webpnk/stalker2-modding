...
Route::localized(function () {
    ...
    Route::get('/read/{category:slug?}', \App\Http\Controllers\Blog\BlogListController::class)->name('blog.list');
    Route::get('/read/{category:slug}/{post:slug}', \App\Http\Controllers\Blog\BlogPostController::class)
        ->name('blog.post');

    Route::get('/mods/minor-improvements', \App\Http\Controllers\ModsListController::class)->name('mods.list');
